 ...
 *
 */
public class OmMwsOrderPayment extends BaseDTO {
    ...
    private List<OmMwsOrderPayment> payData;

    public List<OmMwsOrderPayment> getPayData() {
        return payData;
    }

    public void setPayData(List<OmMwsOrderPayment> payData) {
