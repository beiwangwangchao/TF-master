 ...
 */
public class UserConstants extends BaseConstants {
    /**
     * 用户管理 - 用户资料详情页面链接.
     */
    public static final String USER_INSERT_URL = "/admin/sys/um/sys_user_list";
    /**
     * 密码管理 - 忘记密码 - 验证码有效时间(s).
     */
     ...
     * 正则表达式-loginName.
     */
    public static final String LOGIN_NAME_REGEX = "^[A-Za-z0-9]{4,20}$";
    /**
     * 正则表达式-userName.
     */
     ...
     * 发送限制次数.
     */
    public static final Integer SENT_LIMIT = 2;
