...
(function ($) {
    ...
    liger.win = {
        ...
        queue: [],
        add: function (win) {
            if (jQuery.inArray(win, this.queue) == -1)
            //if(this.queue.indexOf(win) == -1)
                this.queue.push(win);
        },
        remove: function (win) {
            var g = this, q = g.queue;
            q.splice(jQuery.inArray(win, q), 1);
...
(function ($) {
    ...
    $.ligerDefaults.CheckBox = {
        ...
        onClick: null   //点击事件 add by chuangsheng.zhang@hand-china.com 2016-08-29
    };
    ...
    $.ligerui.controls.CheckBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function () {
            ...
            function change() {
                ...
                //  edit by chuangsheng.zhang@hand-china.com 2016-08-29
                g.trigger("click");
...
(function ($) {
    ...
    $.ligerDefaults.DateEditorString = {
        dayMessage: [$l('type.hand.commom.date.daysmin.sunday'), $l('type.hand.commom.date.daysmin.monday'), $l('type.hand.commom.date.daysmin.tuesday'), $l('type.hand.commom.date.daysmin.wednesday'), $l('type.hand.commom.date.daysmin.thursday'), $l('type.hand.commom.date.daysmin.friday'), $l('type.hand.commom.date.daysmin.saturday')],
        monthMessage: [$l('type.hand.commom.date.monthsshort.january'),
        ...
        todayMessage: $l('type.hand.commom.date.today'),
        closeMessage: $l('sys.hand.btn.close')
    };
                    ...
                    if (g.dateeditor.is(":visible")) {
                        switch (e.keyCode) {
                            ...
                            case 40:
                                ...
                                break;
                            case 13:
                                selectDate.call($("td.l-box-dateeditor-over", g.body.tbody));
                                break;
                            case 9:
                                g.toggleDateEditor(true);
                            default: {
...
(function ($) {
    ...
    $.ligerDefaults.DialogString = {
        titleMessage: $l('sys.hand.tip.info'),                     //提示文本标题
        ok: $l('sys.hand.btn.ok'),
        yes: $l('sys.hand.btn.yes'),
        no: $l('sys.hand.btn.no'),
        cancel: $l('sys.hand.btn.cancel'),
        waittingMessage: $l('sys.hand.tip.waitting')
    };
...
(function ($) {
    ...
    $.ligerDefaults.GridString = {
        errorMessage: 'Error',
        pageStatMessage: $l('sys.hand.grid.pageinfo'),
        pageTextMessage: 'Page',
        loadingMessage: $l('sys.hand.tip.loading'),
        findTextMessage: $l('sys.hand.btn.query'),
        noRecordMessage: '没有符合条件的记录存在',
        isContinueByDataChanged: '数据已经改变,如果继续将丢失数据,是否继续?',
        cancelMessage: $l('sys.hand.btn.cancel'),
        saveMessage: $l('sys.hand.btn.save'),
        applyMessage: $l('sys.hand.btn.ok'),
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        endEdit: function (rowParm) {
            var g = this, p = this.options;
            if (g.editor.editing) {//modify by huazhen.wu@hand-china.com start
                var o = g.editor;
...
//            g._buildPager();
        ...
        _applyEditor: function (obj) {
            ...
            var jcell = $(dom);
            var row = jcell.parent(), rowdata = g.getRow(row[0]), rowid = rowdata['__id'],
                rowindex = rowdata['__index'];
            ...
            //modify by huazhen.wu@hand-china.com start
                ...
                if (g.enabledCheckbox()) //复选框选择行
                {
                    ...
                    if (!src.checkbox && src.cell && p.enabledEdit && p.clickToEdit) {
                        ...
                        }, 100);//modify by huazhen.wu@hand-china.com
                    }
                }
...
(function ($) {
    ...
    $.ligerui.controls.PopupEdit.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function () {
            ...
            g.inputText.click(function () {
                if (p.disabled) return;
            }).change(function () {   //njq.niu@hand-china.com
                if (p.disabled) return;
            ...
            if (p.autocomplete) {
                ...
                g.inputText.keypress(function (e) {
                    ...
                    if (/[a-zA-Z]/.test(str)) {
                        _delayRun(function () {
                            g._autoCompleteQuery(queryed = input.value)
                        }, 600);
                    }
                }).keyup(function (e) {
                    if (p.disabled || p.readonly) return;
        ...
        function show() {
            ...
            win = $.ligerDialog.open({
                ...
                buttons: [
                    //modify by njq.niu@hand-china.com
                    {
                        text: $l('sys.hand.btn.ok'), attr: {id: 'pop_ok'}, onclick: function (item, dialog) {
                            toSelect();
                            dialog.close();
                        }
                    },
                    {
                        text: $l('sys.hand.btn.cancel'), attr: {id: 'pop_cancel'}, onclick: function (item, dialog) {
                            dialog.close();
                        }
                    }
                ]
                ...
                $("div", containerBtn1).ligerButton({
                    ...
                    click: function () {
                        ...
                        if (p.grid.needQueryParam && hasParam == false) {
                            //$.ligerDialog.alert('请输入查询条件!', $l('sys.hand.tip.info'), 'alert');
...
(function ($) {
    ...
    $.ligerDefaults.TabString = {
        closeMessage: $l('sys.hand.btn.close'),
        closeOtherMessage: $l('sys.hand.tab.close_others'),
        closeAllMessage: $l('sys.hand.tab.close_all'),
        reloadMessage: $l('sys.hand.btn.refresh')
    };
        ...
        addItem: function (item) {
            ...
            if (item.menu) {
                ...
                ditem.hover(function () {
                    ...
                    var left = $(this).offset().left;
                    var top = $(this).offset().top + $(this).height();
                    item.menu.show({top: top, left: left}, item.menu.options.menu);
