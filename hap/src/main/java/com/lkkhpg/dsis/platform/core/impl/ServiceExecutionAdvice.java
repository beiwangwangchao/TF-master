...
import com.lkkhpg.dsis.platform.core.IRequestAware;
import com.lkkhpg.dsis.platform.dto.BaseDTO;
import com.lkkhpg.dsis.platform.dto.DTOClassInfo;
import com.lkkhpg.dsis.platform.interceptor.AuditInterceptor;
...
public class ServiceExecutionAdvice implements MethodInterceptor {
    ...
    private void autoAssignStdProperty(Logger logger, IRequest request, BaseDTO dto, boolean stdWhoSupport) {
        if (stdWhoSupport) {
            dto.setCreatedBy(request.getAccountId());
            dto.setLastUpdatedBy(request.getAccountId());
