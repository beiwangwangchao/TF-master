...
public interface IMessageService extends ProxySelf<IMessageService> {
    ...
    /**
     * @param sender           发送人ID user_id
     * @param marketId         市场ID
     * @param emailAccountCode 发送账号编号
     * @param subject          标题
     * @param content          内容
     * @param priority         优先级
     * @param receivers        接收者
     * @param attachmentIds    附件列表可以为null
     * @return Message
     * @throws Exception
     */
...
//    Message sendSmsMessage(Long sender, Long marketId, String templateCode, String smsAccountCode,
//                           Map<String, Object> data, List<MessageReceiver> receivers, String interface_address,
...
//    ) throws Exception;
     ...
     * @throws Exception
     */
    void sendSmsMessage(Long sender,String smsAccountCode,
                           Map<String, Object> data, List<MessageReceiver> receivers) throws Exception;
