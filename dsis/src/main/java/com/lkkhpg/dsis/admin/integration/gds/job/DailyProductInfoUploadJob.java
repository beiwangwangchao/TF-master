 ...
 * @author fengwanjun
 */
public class DailyProductInfoUploadJob extends AbstractJob {

    private Logger logger = LoggerFactory.getLogger(DailyProductInfoUploadJob.class);

    @Autowired
    private IDailyProductInfoUploadService dailyProductInfoUploadService;
...
//      isgGdsProcedureParam.setReturnMessage("");
        ...
        try {
            if (context.getScheduledFireTime() == null) {
                isgGdsProcedureParam.setDateFrom(
            ...
            if (context.getNextFireTime() == null) {
                isgGdsProcedureParam.setDateTo(
                        new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
        ...
        int result = dailyProductInfoUploadService.dailyProductInfoUpload(isgGdsProcedureParam);
