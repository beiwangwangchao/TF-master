 ...
 * @author fengwanjun
 */
public class DailyProductPriceUploadJob extends AbstractJob {
    
    private Logger logger = LoggerFactory.getLogger(DailyProductPriceUploadJob.class);
    
    @Autowired
    private IDailyProductPriceUploadService dailyProductPriceUploadService;
...
//  isgGdsProcedureParam.setReturnMessage("");
    ...
    int result = dailyProductPriceUploadService.dailyProductPriceUpload(isgGdsProcedureParam);
