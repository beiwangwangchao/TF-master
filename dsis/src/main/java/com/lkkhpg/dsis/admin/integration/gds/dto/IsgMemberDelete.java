...
public class IsgMemberDelete {
    ...
    private List<IsgMemberDeleteDetail> details;
    ...
    public List<IsgMemberDeleteDetail> getDetails() {
        return details;
    }

    public void setDetails(List<IsgMemberDeleteDetail> details) {
