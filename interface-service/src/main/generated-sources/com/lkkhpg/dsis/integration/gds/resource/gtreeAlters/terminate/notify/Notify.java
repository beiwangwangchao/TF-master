...
package com.lkkhpg.dsis.integration.gds.resource.gtreeAlters.terminate.notify;
...
import com.lkkhpg.dsis.integration.gds.resource.gtreeAlters.terminate.notify.model.NotifyPOSTHeader;
import com.lkkhpg.dsis.integration.gds.resource.gtreeAlters.terminate.notify.model.NotifyPOSTQueryParam;
...
public class Notify {
    ...
    /**
     * (treeAlterPrecess) 批刪處理通知 GDS
     * 
     */
    public com.lkkhpg.dsis.integration.gds.resource.gtreeAlters.terminate.notify.model.NotifyPOSTResponse post(NotifyPOSTBody body, NotifyPOSTQueryParam queryParameters, NotifyPOSTHeader headers) {
        ...
        return response.readEntity(com.lkkhpg.dsis.integration.gds.resource.gtreeAlters.terminate.notify.model.NotifyPOSTResponse.class);
    }
