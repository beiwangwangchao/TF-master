...
package com.lkkhpg.dsis.integration.gds.resource.dealers.batchSave;
...
import com.lkkhpg.dsis.integration.gds.resource.dealers.batchSave.model.BatchSavePOSTHeader;
import com.lkkhpg.dsis.integration.gds.resource.dealers.batchSave.model.BatchSavePOSTQueryParam;
...
public class BatchSave {
    ...
    /**
     * (batchSaveDealer) 小批量同步會員資料 - 對於會員的新增、修改、刪除,可支援通過後臺批量同步的方式上傳到 GDS
     * 
     */
